const en = {
  ...
  marketplace: {
    ...
    // Two-sided board: people selling equipment, and people looking for it
    postTypes: {
      selling: "For Sale",
      wanted: "Wanted",
    } as Record<string, string>,
    postTypeHints: {
      selling: "Used equipment offered by members",
      wanted: "Members looking for equipment to buy",
    } as Record<string, string>,
    wantedBadge: "Wanted",
    wantedBudget: "Budget",
    wantedNoResults: "No wanted posts match your criteria.",
    wantedResultCount: (n: number) => `${n} wanted post${n !== 1 ? "s" : ""}`,
    postItem: "Sell an Item",
  ...
  shops: {
    ...
    types: {
      rent: "Shop for Rent",
      takeover: "Business Takeover",
      both: "Rent or Takeover",
    } as Record<string, string>,
    resultCount: (n: number) => `${n} listing${n !== 1 ? "s" : ""}`,
    noResults: "No shop listings match your criteria.",
    postListing: "Post a Listing",
    // Two-sided board: spaces on offer, and members looking for one
    postTypes: {
      available: "Available",
      wanted: "Wanted",
    } as Record<string, string>,
    postTypeHints: {
      available: "For Rent / Takeover",
      wanted: "Looking for Shop / Business",
    } as Record<string, string>,
    wantedBadge: "Looking for",
    postAvailable: "Post For Rent / Takeover",
    postWanted: "Post Looking For",
    noResultsWanted: "No wanted posts match your criteria.",
    wantedResultCount: (n: number) => `${n} request${n !== 1 ? "s" : ""}`,
    wantedSearchPlaceholder: "Search by preferred area, business type...",
    features: {
      "exhaust-hood": "Exhaust Hood",
      "gas-supply": "Gas Supply",
      "fully-fitted-kitchen": "Fully Fitted Kitchen",
    ...
    detail: {
      ...
      location: "Location",
      building: "Building / Mall",
      monthlyRent: "Monthly Rent (SGD)",
      floorSize: "Floor Size",
      askingPrice: "Asking Price (Takeover)",
      ...
      postedBy: "Posted by",
      postedOn: "Posted on",
      contactHint: "Contact the poster on WhatsApp for viewings and details.",
      notFound: "Listing not found.",
      pendingNotice: "This listing is awaiting admin approval and is only visible to you.",
      rejectedNotice: "This listing was rejected and is only visible to you.",
      // Same fields, re-labelled when the post is a "Looking for" request
      wanted: {
        location: "Preferred Location",
        building: "Preferred Building / Mall",
        monthlyRent: "Rent Budget (SGD)",
        floorSize: "Preferred Floor Size",
        askingPrice: "Takeover Budget",
        leaseRemaining: "Preferred Lease Term",
        suitableFor: "Business Type",
        keyFeatures: "Must-have Features",
        reason: "Target Opening",
        description: "What they are looking for",
        contactHint: "Contact this member on WhatsApp if you have a matching space.",
    ...
    form: {
      ...
      fieldTitle: "Listing Title (English only) *",
      fieldTitlePlaceholder: "e.g. Japanese Restaurant at Tanjong Pagar for Takeover",
      fieldListingType: "Listing Type *",
      fieldListingTypePlaceholder: "e.g. Business Takeover, Shop for Rent, or Both",
      fieldLocation: "Location *",
      fieldLocationPlaceholder: "e.g. Tanjong Pagar, Bugis, Orchard",
      fieldBuilding: "Building / Mall",
      fieldBuildingPlaceholder: "e.g. VivoCity, Bugis Junction, Shophouse",
      fieldMonthlyRent: "Monthly Rent (SGD)",
      fieldMonthlyRentPlaceholder: "e.g. S$8,500/month",
      fieldFloorSize: "Floor Size",
      fieldFloorSizePlaceholder: "e.g. 850 sqft",
      fieldAskingPrice: "Asking Price (Takeover)",
      fieldAskingPricePlaceholder: "e.g. S$60,000",
      fieldLeaseRemaining: "Lease Remaining",
      fieldLeaseRemainingPlaceholder: "e.g. 2 years remaining",
      fieldSuitableFor: "Suitable For",
      fieldSuitableForPlaceholder: "e.g. Japanese Restaurant, Café, Bakery, Western Cuisine",
      fieldKeyFeatures: "Key Features",
      fieldKeyFeaturesHint: "Select all that apply",
      fieldOtherFeaturePlaceholder: "Other features, e.g. Grease Trap, Walk-in Chiller",
      fieldReason: "Reason for Transfer (Optional)",
      fieldReasonPlaceholder: "e.g. Relocation, Retirement, Change of Business",
      fieldDescription: "Description (English only) *",
      fieldDescriptionPlaceholder:
        "Describe the shop, equipment included, condition, nearby foot traffic, and any other important information.",
      fieldContactName: "Your Name (English only) *",
      fieldContactNamePlaceholder: "Name (English only)",
      ...
      imageTooLargeError: "Image is too large. Maximum size is 10 MB.",
      ...
      fieldPostType: "What are you posting? *",
      postTypeAvailable: "I have a shop / business to offer",
      postTypeAvailableHint: "For Rent or Takeover",
      postTypeWanted: "I'm looking for a shop / business",
      postTypeWantedHint: "Wanted — Looking for Shop / Business",
      // Labels that replace the ones above when posting a "Looking for" request
      wanted: {
        title: "New 'Looking For' Post",
        fieldTitle: "Post Title (English only) *",
        fieldTitlePlaceholder: "e.g. Looking for a 600-900 sqft cafe space in the East",
        fieldListingType: "What are you looking for? *",
        fieldListingTypePlaceholder: "e.g. Shop to rent, Business to take over, or either",
        typeRent: "Shop to rent",
        typeTakeover: "Business to take over",
        typeBoth: "Either is fine",
        fieldLocation: "Preferred Location *",
        fieldLocationPlaceholder: "e.g. East, Central, near an MRT",
        fieldBuilding: "Preferred Building / Mall type",
        fieldBuildingPlaceholder: "e.g. Shophouse, Mall unit, Coffee shop stall",
        fieldMonthlyRent: "Rent Budget (SGD)",
        fieldMonthlyRentPlaceholder: "e.g. up to S$6,000/month",
        fieldFloorSize: "Preferred Floor Size",
        fieldFloorSizePlaceholder: "e.g. 600-900 sqft",
        fieldAskingPrice: "Takeover Budget",
        fieldAskingPricePlaceholder: "e.g. up to S$50,000",
        fieldLeaseRemaining: "Preferred Lease Term",
        fieldLeaseRemainingPlaceholder: "e.g. at least 2 years",
        fieldSuitableFor: "Business Type",
        fieldSuitableForPlaceholder: "e.g. Japanese Restaurant, Cafe, Bakery",
        fieldKeyFeatures: "Must-have Features",
        fieldReason: "Target Opening Date (Optional)",
        fieldReasonPlaceholder: "e.g. Within 3 months",
        fieldDescription: "Details (English only) *",
        fieldDescriptionPlaceholder:
    ...
    dashboard: {
      sectionTitle: "My Shop Listings",
      newListing: "New Shop Listing",
      noListings: "No shop listings yet.",
      firstListing: "Post First Listing",
      deleteConfirm: "Delete this shop listing?",
    },
  },
  ...
  community: {
    ...
    sortLabel: "Sort",
    sortActivity: "Latest activity",
    sortNewest: "Newest thread",
    categories: {
    ...
    categoryHints: {
      general: "Anything F&B — advice and general discussion",
      suppliers: "Ingredients, drinks, packaging, cleaning and service providers",
      staff: "Hiring, people, pay and managing a team",
      shop: "Premises, rent, takeover and location",
      equipment: "Kitchen equipment, repairs, maintenance and daily operations",
      business: "Sales, footfall, social media, ads, pricing and management",
      collaboration: "Collaborations, pop-ups, events and business partners",
    } as Record<string, string>,
    threadCount: (n: number) => `${n} thread${n !== 1 ? "s" : ""}`,
    ...
    loadMore: "Load more",
    loginToPost: "Log in to start a thread or reply. Posting is free.",
    dbBanner: "The community board is being set up. Please try again later.",
    pinned: "Pinned",
    locked: "Locked",
    hidden: "Hidden",
    tagsLabel: "Tags",
    ...
    form: {
      ...
      fieldTitle: "Title *",
      fieldTitlePlaceholder: "e.g. Any recommendations for a reliable seafood supplier?",
      fieldCategory: "Category *",
      fieldTags: "Tags (optional)",
      fieldTagsHint: "Up to 5 tags. Separate with commas, or pick from the suggestions.",
      fieldTagsPlaceholder: "e.g. Cafe, Halal, Central Area",
      fieldContent: "Content *",
      fieldContentPlaceholder:
        "Share the details — what you tried, what you need, and anything that would help someone answer.",
      submit: "Post Thread",
      submitting: "Posting...",
      saveChanges: "Save changes",
      saving: "Saving...",
      cancel: "Cancel",
      errorRequired: "Please enter a title and content.",
      errorFailed: "Could not post. Please try again.",
      successMsg: "Your thread has been posted.",
    },
    thread: {
      ...
      replyPlaceholder: "Share your experience or answer the question...",
      replySubmit: "Post Reply",
      replySubmitting: "Posting...",
      replyFailed: "Could not post your reply. Please try again.",
      loginToReply: "Log in to join this discussion.",
      lockedNote: "This thread is locked — no new replies can be added.",
      edit: "Edit",
      delete: "Delete",
      deleteConfirm: "Delete this thread? Its replies will be removed too.",
    ...
    guidelines:
      "Keep it useful and respectful. No spam, no personal data, and no pricing sheets you are not allowed to share.",
  },
  ...
  newItem: {
    ...
    // Which side of the board this post belongs to
    fieldPostType: "What are you posting? *",
    postTypeSelling: "I'm selling an item",
    postTypeSellingHint: "Listed under For Sale",
    postTypeWanted: "I'm looking to buy an item",
    postTypeWantedHint: "Listed under Wanted",
    wanted: {
      title: "New Wanted Ad",
      fieldTitle: "Title (English only) *",
      fieldPrice: "Budget (SGD) (numbers only) *",
      fieldCondition: "Acceptable Condition *",
      fieldYearsUsed: "Max Age in Years (numbers only) *",
      fieldDescription: "What you are looking for (English only) *",
      fieldArea: "Preferred Area *",
      fieldDelivery: "Collection Method",
      fieldImages: "Reference Images (optional, max 5)",
      submit: "Post Wanted Ad (published after review)",
      successMsg: "Your wanted ad has been submitted. It will be published after admin approval.",
    },
  },
