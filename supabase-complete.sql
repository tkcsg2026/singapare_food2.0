...
-- ──────────────────────────────────────────────────────────────
-- 17. SHOP LISTINGS — "Shops for Rent / Takeover" board
-- ──────────────────────────────────────────────────────────────
...
-- ──────────────────────────────────────────────────────────────
-- 18. VERIFY — row counts after full setup
-- ──────────────────────────────────────────────────────────────
SELECT table_name, rows FROM (
  ...
  SELECT 'scrolling_banner',                    COUNT(*)         FROM public.scrolling_banner   UNION ALL
  SELECT 'shop_listings',                       COUNT(*)         FROM public.shop_listings
